    ...
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      ...
      {loading ? (
        <div className="flex items-center justify-center py-4">
          ...
          <span className="ml-2 text-gray-600">Verificando servidores...</span>
        </div>
      ) : (
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center">
              <div className={`w-3 h-3 rounded-full mr-3 ${getStatusColor(serverStatus.proxy)}`}></div>
              <div>
                <p className="font-medium text-gray-800">Proxy de Desarrollo</p>
                <p className="text-sm text-gray-600">/tryton → localhost:8000</p>
              </div>
            </div>
            <span className="text-sm font-medium text-gray-700">
              {getStatusText(serverStatus.proxy)}
            </span>
          </div>
          ...
          {serverStatus.proxy === 'error' && serverStatus.tryton === 'running' && (
